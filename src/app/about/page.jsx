      ...
      <div className="max-w-4xl mx-auto mt-10 bg-white p-8 rounded-lg shadow-lg">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            At Task Management, it strive to streamline work assignments and enhance productivity within your organization.
        ...
        <p className="text-center text-gray-700 mt-8">
          Thank you for choosing Task Management. We are excited to be a part of your journey towards greater productivity and collaboration!
        </p>
      </div>
    </div>
  );
